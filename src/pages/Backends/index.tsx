      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <h2 className="text-xl font-bold text-blue-lbg mb-4">
              Datastores
            </h2>
            <div className="text-gray-700 leading-relaxed space-y-3">
              <div className="flex items-start">
                <span className="w-2 h-2 bg-blue-lbg rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p className="text-sm">Datastores in Darklang are key-value stores used for persistent data storage, integrated seamlessly with handlers and workers.</p>
              </div>
              <div className="flex items-start">
                <span className="w-2 h-2 bg-blue-lbg rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p className="text-sm">when you set up a database in dark, you just add the database, like you click a button or a keyboard shortcut, no requiring a server from somewhere to put it on, no going to another server, no config, no orm it is written in the same language as the rest of your code</p>
              </div>
              <div className="flex items-start">
                <span className="w-2 h-2 bg-blue-lbg rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p className="text-sm">when you make a query, you query in the dark</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="text-gray-700 leading-relaxed space-y-3">
              <div className="flex items-start">
                ...
                <p className="text-sm">HTTP handlers in Darklang are the core mechanism for handling incoming HTTP requests, serving as the entry point for API endpoints and web applications.</p>
              </div>
              <div className="flex items-start">
                <span className="w-2 h-2 bg-purple-lbg rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p className="text-sm">when setting up a HTTP request you're not setting up a HTTP server, you're just add an end point that is directly connected to the code and you write them in the same place. There's no spinning up servers</p>
              </div>
              <div className="flex items-start">
                <span className="w-2 h-2 bg-purple-lbg rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p className="text-sm">Darklang is designed for interacting with 3rd party APIs over HTTP. The `HttpClient` module has a set of functions for calling out to other HTTP services and APIs</p>
              </div>
            </div>
          </div>
          ...
          {/* Scheduled Jobs */}
          <div className="bg-white rounded-lg shadow-lg p-6">
            <h2 className="text-xl font-bold text-mint mb-4">
              Scheduled Jobs
            </h2>
            <div className="text-gray-700 leading-relaxed space-y-3">
              <div className="flex items-start">
                <span className="w-2 h-2 bg-mint rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p className="text-sm">CRON jobs in Darklang are scheduled tasks that run on a predefined schedule, similar to Unix cron, ideal for periodic tasks like report generation or data cleanup.</p>
              </div>
              <div className="flex items-start">
                <span className="w-2 h-2 bg-mint rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p className="text-sm">Crons run automatically once per interval</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="text-gray-700 leading-relaxed space-y-3">
              <div className="flex items-start">
                ...
                <p className="text-sm">Workers in Darklang handle asynchronous background tasks, processing messages from a queue, making them ideal for tasks like API calls, batch processing, or report generation.</p>
              </div>
            </div>
          </div>
        </div>
