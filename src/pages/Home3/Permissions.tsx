...
const Permissions: React.FC = () => (
  ...
  >
    <p>
      Nothing is allowed until you allow it, and a rule names the exact URL,
      file path, port or process. Not &quot;the network&quot;, but this one
      request, down to the query string.
    </p>
    <p>
      A function declares its ceiling in its own signature, just before the
      return type, so the ceiling travels in the content hash with the code:{" "}
    ...
    <p>
      What a function requires is worked out from its code rather than declared
      by hand, including code inside closures it might hand back later. A
      package can only ask for what it needs. Turning that ask into a rule is
      yours alone.
    </p>
    <Facts
      color="bg-rust"
