      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mt-6 max-w-3xl mx-auto">
            Here's how you can start exploring Darklang and connect with our community.
          </p>
        </div>
        ...
        <div className="bg-blue-50 border-l-4 border-blue-lbg p-6 mb-8 rounded-lg">
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h3 className="text-lg font-medium text-blue-800">Development Status</h3>
              <p className="text-blue-700 mt-1">
                We're transforming Darklang from the original browser-based editor to a 
                CLI and editor-based development experience. The new version will be 
                available for broader use soon.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <div className="border-l-4 border-mint pl-4">
                <h3 className="font-semibold text-gray-800 mb-2">Join Our Discord</h3>
              ...
              <div className="border-l-4 border-taupe pl-4">
                <h3 className="font-semibold text-gray-800 mb-2">Follow Our Progress</h3>
                <p className="text-gray-600 text-sm mb-3">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-blue-lbg pl-4">
                ...
                <p className="text-gray-600 text-sm mb-3">
                  Explore Darklang using our VS Code devcontainer setup. This gives you 
                  access to the latest CLI and language features.
                </p>
                <a 
              ...
              <div className="border-l-4 border-purple-lbg pl-4">
                <h3 className="font-semibold text-gray-800 mb-2">VS Code Extension</h3>
                <p className="text-gray-600 text-sm mb-3">
                  Our VS Code extension provides syntax highlighting, LSP features, 
                  and integration with the Darklang package manager.
                </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-6">
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">A stable command-line interface for running Darklang programs, managing packages, and deploying applications</div>
                  </div>
                </div>
                <div className="flex items-start">
                  <span className="w-3 h-3 bg-purple-lbg rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <div>
                    <div className="font-medium text-gray-800">Package Manager</div>
                    <div className="text-sm text-gray-600">Function-level package distribution</div>
                  </div>
                </div>
                <div className="flex items-start">
                  <span className="w-3 h-3 bg-mint rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <div>
                    <div className="font-medium text-gray-800">LSP for General Use</div>
                    <div className="text-sm text-gray-600">Language Server Protocol support for any editor, enabling code completion, diagnostics, and more</div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <div className="font-medium text-gray-800">MCP Server Support</div>
                    <div className="text-sm text-gray-600">Build Model Context Protocol servers quickly to extend AI assistant capabilities</div>
                  </div>
                </div>
                <div className="flex items-start">
                  <span className="w-3 h-3 bg-rose rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <div>
                    <div className="font-medium text-gray-800">VS Code Extension</div>
                    <div className="text-sm text-gray-600">Official extension with syntax highlighting, debugging, and integrated package management</div>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Comprehensive guides and API references</div>
                  </div>
                </div>
              </div>
            </div>
