...
const Versioning: React.FC = () => (
  ...
  >
    <p>
      Every function, type and value is kept forever and identified by its
      content, not by a file and a line number. A name is just a binding
      pointing at one of those identities.
    </p>
    <p>
