            ...
            <div className="max-w-7xl 2xl:max-w-[100rem] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
                ...
                <div className="text-center mb-18 text-xl md:text-3xl xl:text-[28px]">
                    <div className="mb-12">
                        ...
                        <span className="text-white"> is a new way of building serverless backends. Just code your backend, with no infra, framework or deployment nightmares. Build </span>
                ...
                <div className="mb-20">
                    ...
                    <div className="flex justify-center mb-20">
                        ...
                        >
                            <div className="flex justify-center items-center">
                                <button
                                    className="bg-classic-purple text-white font-bold py-2 px-2 rounded-full inline-flex items-center justify-center relative"
                                >
                                    <span
                                        className="absolute w-full h-full bg-classic-purple rounded-full opacity-75 animate-ping"
                                    ></span>
                                    <svg
                                        viewBox="0 0 16 16"
                    ...
                    <div className="bg-dark-black rounded-lg p-8 flex flex-col md:flex-row items-center justify-between mx-auto w-full max-w-4xl">
                        <h3 className="text-xl font-semibold text-white mb-4 md:mb-0">Access Darklang-classic</h3>
