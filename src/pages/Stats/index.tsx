      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-yellow-700 text-sm">
                This page is an early preview of our vision for public
                transparency around performance metrics, usage statistics, and
                platform health. The specific numbers shown are illustrative
                examples. As Darklang develops, we plan to provide real-time,
                publicly accessible stats including performance data, system
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-mono text-sm bg-teal-100 text-teal-800 px-2 py-1 rounded">
                    ~50ms
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Deploy Time</span>
                  <span className="font-mono text-sm bg-pink-100 text-pink-800 px-2 py-1 rounded">
                    Instant
                  </span>
                </div>
              </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          ...
          <div className="text-gray-700 leading-relaxed space-y-4">
            <p>
              We're committed to transparent, usage-based pricing that follows
              our actual infrastructure costs. Our goal is to keep basic
              websites affordable while scaling predictably for larger
              applications.
            </p>
            <div className="bg-green-50 p-4 rounded-lg">
              <p className="text-sm text-green-800">
                <strong>Our target:</strong> Anyone should be able to afford
                running a small website. We're working toward pricing that makes
                this accessible to everyone.
              </p>
            </div>
            <p className="text-sm text-gray-600">
              Specific pricing will be announced as our cloud hosting becomes
              available.
            </p>
          </div>
        </div>
          ...
          <div className="flex">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mb-2">
                We believe in building a sustainable platform with transparent
                operations. As we develop, we'll share real metrics about
                platform health, performance, and growth.
              </p>
              <a
