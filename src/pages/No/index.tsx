      ...
      <div className="max-w-5xl 2xl:max-w-6xl mx-auto">
            ...
            <div className="bg-rust/3 rounded-lg p-6  border-rust/70">
              ...
              <div className="space-y-3 text-sm">
                <div>
                  ...
                  <span className="text-gray-600 ml-2">
                    Code is stored as compiled ASTs
                  </span>
                </div>
                <div>
                  <span className="font-semibold text-rust">
                  ...
                  <span className="text-gray-600 ml-2">
                    Incremental compilation happens automatically
                  </span>
                </div>
                <div>
                  <span className="font-semibold text-rust">
            ...
            <div className="bg-tan/5 rounded-lg p-6  border-tan">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <span className="text-gray-600 ml-2">
                    Language runtime provides isolation
                  </span>
                </div>
                <div>
                  <span className="font-semibold text-taupe">
        ...
        <div className="mb-20">
          ...
          <div className="space-y-4 text-gray-700">
            <p className="text-lg">
              Every "no" represents a conscious choice to eliminate accidental
              complexity.
            </p>
            <p>
              These aren't limitations—they're liberations. When you don't need
              to think about YAML files, Docker containers, or database
              connection pooling, you can focus on what actually matters:
              building your product and serving your users.
            </p>
            <p>
            ...
            <div className="mt-6 p-4 bg-gradient-to-br from-purple-50 to-indigo-50 rounded-lg">
              <p className="text-sm text-blue-lbg">
                ...
                >
                  eliminating the "layers of accidental complexity" in backend
                  development
                </a>
                .
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Write a function, save it, and it's running in production. No
                build steps, no containers, no configuration.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Gradual static typing with no null values or exceptions. Errors
                are explicit and handled at compile time.
              </p>
            </div>
