const Roadmap = () => {
  return (
    <div className="max-w-4xl mx-auto py-16 px-4">
      <h1 className="text-3xl font-bold mb-8 text-black-custom">
        Darklang Roadmap
      </h1>

      <div className="prose max-w-none">
        <p className="text-lg mb-8">
          At Darklang, we're committed to building a powerful yet simple
          platform for backend development. Our roadmap outlines our vision for
          the future and the features we're working on.
        </p>
        ...
        <div className="mt-12 p-6 bg-gray-50 rounded-lg">
          ...
          <p className="mb-4">
            We believe in building in public and with our community. Have
            suggestions or feature requests? We'd love to hear from you!
          </p>
