          ...
          <div className="flex flex-wrap gap-4 mb-8 max-w-5xl justify-center mx-auto">
            ...
            <FeatureButton
              ...
              {<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                <path d="M5.83301 14V21C5.83301 21 5.83301 24.5 13.9997 24.5C22.1663 24.5 22.1663 21 22.1663 21V14" stroke="#755580" stroke-width="1.5" />
                <path d="M5.83301 7V14C5.83301 14 5.83301 17.5 13.9997 17.5C22.1663 17.5 22.1663 14 22.1663 14V7" stroke="#755580" stroke-width="1.5" />
                <path d="M13.9997 3.5C22.1663 3.5 22.1663 7 22.1663 7C22.1663 7 22.1663 10.5 13.9997 10.5C5.83301 10.5 5.83301 7 5.83301 7C5.83301 7 5.83301 3.5 13.9997 3.5Z" stroke="#755580" stroke-width="1.5" />
              </svg>}
              label="Data stores"
