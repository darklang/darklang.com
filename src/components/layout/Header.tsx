...
const Header = ({ currentPage }: HeaderProps) => {
    ...
    return (
        <header className={`${bgColor} py-4`} >
            ...
            {/* Mobile Menu */}
            {isMobileMenuOpen && (
                <div className={`md:hidden ${bgColor} py-4 px-6 absolute w-full z-50 shadow-lg`}>
                    <nav>
