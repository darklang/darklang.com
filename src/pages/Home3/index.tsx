...
const Home3 = () => {
  const tocItems = [
    { id: "hero", title: "A Safer Way to Run Code" },
    { id: "walkthrough", title: "From an Empty Machine to a Live Endpoint" },
    { id: "language", title: "A Type Checker, Not a Build Step" },
    ...
    { id: "build", title: "A Backend, a CLI and a Script" },
