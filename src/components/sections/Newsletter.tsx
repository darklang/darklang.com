        ...
        <div className="bg-white rounded-lg shadow-md inset-shadow-sm p-8 md:p-12 max-w-4xl mx-auto">
          ...
          {!isSuccess ? (
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-2xl font-bold mb-2 text-black-custom">Thanks for subscribing!</h3>
              <p className="text-gray-600">We'll send you updates about Darklang project milestones.</p>
              <button
