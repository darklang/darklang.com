...
/** A dark terminal panel, used for the examples beside each section. */
const Console: React.FC<{
  ...
  <div
    className={`rounded-2xl border border-[#333336] bg-dark-black overflow-hidden shadow-sm ${className}`}
  >
...
/** A shell prompt, so every example reads as something you could paste. */
export const P: React.FC = () => <span className="text-gray-dark">$ </span>;
