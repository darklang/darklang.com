...
const ACTS = [
  ...
  },
  {
    name: "Watch",
    caption:
      "Definitions appear as they are written, each declaring the access it needs.",
  },
  {
    name: "Allow",
    caption:
  ...
  },
  {
    name: "Run",
    caption:
      "Your router is a function, so serving it is one command. The run it handles keeps its inputs, its outside calls and what came back.",
  },
  {
    name: "Change",
    caption:
      "Callers follow a change, but not one that needs more access than you approved. That version waits for you.",
  },
  {
    name: "Ship",
    caption:
...
const SESSION: Def = {
  ...
  sig: "Order :{Http} -> Result<Session, StripeError>",
  body: [
...
const REFUND: Def = {
  ...
  sig: "Charge :{Http} -> Result<Refund, StripeError>",
  body: [
...
const CONFIRM: Def = {
  ...
  sig: "Order :{Http} -> Result<Unit, String>",
  body: [
        ...
        <div className="mx-auto max-w-6xl rounded-2xl border border-gray-200 bg-[#F9F9FB] p-4 md:p-6">
          ...
          <div className="mb-4 flex flex-wrap items-center justify-center gap-1.5">
            ...
            <button
              ...
              className="ml-1 inline-flex items-center gap-1.5 rounded-full border border-gray-200 bg-white px-3 py-1.5 text-sm text-gray-dark transition-colors hover:border-gray-300"
            >
              {paused ? (
          ...
          <div className="relative h-[34rem] md:h-[30rem]">
            ...
            >
              ...
              <div className="relative min-h-0">
                ...
                <div
                  className={`absolute right-2 bottom-2 left-[42%] z-10 origin-bottom-right transition-all duration-500 ${
                    traceOpen
