  ...
  return (
    <div className="bg-dark text-white font-code">
      ...
      <section className="py-12 pl-6 pr-8 max-w-7xl 2xl:max-w-[100rem] mx-auto">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="md:w-2/3">
            <div className="text-lg md:text-2xl font-medium text-purple-dbg mb-4">$ darklang platform |</div>
      ...
      <section className="py-32 px-6 max-w-7xl 2xl:max-w-[100rem] mx-auto">
        <div className="text-purple-dbg mb-6 text-lg md:text-2xl font-medium">$ darklang get started |</div>

      </section>

      {/* Bash Complexities Section */}
      <section className="py-16 px-6 max-w-7xl 2xl:max-w-[100rem] mx-auto">
        <div className="text-purple-dbg mb-6 text-lg md:text-2xl font-medium">$ darklang solving bash complexities |</div>
      ...
      <section className="py-16 px-6  max-w-7xl 2xl:max-w-[100rem] mx-auto">
        <div className="text-purple-dbg mb-6 text-lg md:text-2xl font-semibold">$ darklang for your scripts |</div>
        <div className='relative'>
          <img src={gridImage} alt="grid" className='hidden md:block w-2xs 2xl:w-sm absolute -right-40 -bottom-45 2xl:-right-120' />
      ...
      <section className="py-16 px-6  max-w-7xl 2xl:max-w-[100rem] mx-auto relative">
        <div className="text-purple-dbg mb-10 text-lg md:text-2xl font-semibold">$ darklang examples |</div>
        ...
        <img src={logoAscii} alt='logo-ascii' className='hidden md:block absolute -left-40 w-xs z-1 -bottom-10' />
      </section>

      {/* Darklang Commands Section */}
      <section className="py-16 px-6 max-w-7xl 2xl:max-w-[100rem] mx-auto">
        <div className="text-purple-dbg mb-10 text-lg md:text-2xl font-semibold">$ darklang commands |</div>
        ...
        <div className="space-y-6 md:ml-6 md:text-lg 2xl:text-xl">
          <div className="flex flex-col space-y-2 md:grid md:grid-cols-12 md:gap-4 md:space-y-0 md:items-start">
            <div className="md:col-span-3">dark <span className="text-blue-dbg">help</span></div>
            <div className="text-white md:col-span-9">Show this help message and exit</div>
          </div>

          <div className="flex flex-col space-y-2 md:grid md:grid-cols-12 md:gap-4 md:space-y-0 md:items-start">
            <div className="md:col-span-3">dark <span className="text-tan">[function name]</span></div>
            <div className="text-white md:col-span-9">Run a function in the package manager i.e. `dark @Darklang.Stdlib.Bool.not true`</div>
          </div>

          <div className="flex flex-col space-y-2 md:grid md:grid-cols-12 md:gap-4 md:space-y-0 md:items-start">
            <div className="md:col-span-3">dark <span className="text-mint">run [script path]</span></div>
            <div className="text-white md:col-span-9">Run a .dark script i.e. `dark ./my-script.dark`</div>
          </div>

          <div className="flex flex-col space-y-2 md:grid md:grid-cols-12 md:gap-4 md:space-y-0 md:items-start">
            <div className="md:col-span-3">dark <span className="text-purple-dbg">install</span></div>
            <div className="text-white md:col-span-9">Install the darklang CLI so it's available globally in your terminal</div>
          </div>

          <div className="flex flex-col space-y-2 md:grid md:grid-cols-12 md:gap-4 md:space-y-0 md:items-start">
            <div className="md:col-span-3">dark <span className="text-sand">http</span></div>
            <div className="text-white md:col-span-9">Lists both local and cloud handlers</div>
          </div>

          <div className="flex flex-col space-y-2 md:grid md:grid-cols-12 md:gap-4 md:space-y-0 md:items-start">
            <div className="md:col-span-3">dark <span className="text-olive">dbs</span></div>
            <div className="text-white md:col-span-9">Lists both local and cloud dbs</div>
          </div>
        </div>
