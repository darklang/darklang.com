              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start">
                  ...
                  <div>
                    <a
                      ...
                      className="text-blue-lbg hover:underline font-medium"
                    >
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Comprehensive language and platform documentation
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Understanding Darklang's "everything in one box" approach
                    </p>
                  </div>
                </li>
              </ul>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <a
                      ...
                      target="_blank"
                      className="text-purple-lbg hover:underline font-medium"
                    >
                      Source Code
                    </a>
                    <p className="text-sm text-gray-600">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 border-[#7B85FF]">
              ...
              <div className="text-sm text-gray-600 mb-4">
                <strong>Best for:</strong> Quick questions, general discussion,
                community help, announcements
              </div>
              <a
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 border-l-4 border-gray-500">
              ...
              <div className="text-sm text-gray-600 mb-4">
                <strong>Best for:</strong> Bug reports, feature requests,
                technical discussions, feedback on development
              </div>
