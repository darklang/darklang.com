      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Create REST APIs and webhooks instantly. No server setup, no
                arduous routing configuration. Just define an endpoint and start
                handling requests.
              </p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900">
                  Integrated Datastores
                </h3>
              </div>
              <p className="text-gray-700 leading-relaxed mb-4">
                Built-in key-value databases that require zero configuration. No
                separate database servers, no ORMs—just store and query data
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Run tasks on a schedule without external cron services. Perfect
                for data cleanup, report generation, API synchronization, and
                maintenance tasks.
              </p>
              <div className="bg-gray-50 p-4 rounded-md">
                <p className="text-sm text-gray-600">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Process tasks asynchronously with message queues. Emit events
                from anywhere in your code and handle them in dedicated worker
                processes.
              </p>
              <div className="bg-gray-50 p-4 rounded-md">
                <p className="text-sm text-gray-600">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          ...
          <div className="text-gray-700 leading-relaxed space-y-6">
            <p>
              These four core features enable you to build complete backend
              applications. Here's what Darklang Classic users built in
              production:
            </p>
        ...
        <div className="border-l-4 border-purple-lbg pl-8 mb-12">
          ...
          <div className="text-gray-700 leading-relaxed space-y-4">
            <p>
              Unlike Darklang Classic which only ran in our cloud, modern
              Darklang gives you deployment flexibility while maintaining the
              same simple development experience.
            </p>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          ...
          <div className="text-gray-700 leading-relaxed space-y-4">
            <p>
              ...
              module makes API calls straightforward, with automatic JSON
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  <div>
                    <strong>Webhook processing:</strong> Receive webhooks from
                    services like GitHub, Stripe, or Shopify and trigger
                    workflows
                  </div>
                </div>
                <div className="flex items-start">
                  <span className="w-2 h-2 bg-purple-lbg rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <div>
                    <strong>API orchestration:</strong> Coordinate calls across
                    multiple services to build composite APIs
                  </div>
                </div>
                <div className="flex items-start">
                  <span className="w-2 h-2 bg-purple-lbg rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <div>
                    <strong>Data synchronization:</strong> Keep data in sync
                    between different systems using scheduled jobs and workers
                  </div>
                </div>
              </div>
            </div>
